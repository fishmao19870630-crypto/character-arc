...
const TASK_DEFAULT_CAPABILITIES: Record<AiTaskName, PromptCapabilityId[]> = {
  ...
  'spiral-characters': ['settings', 'worldview', 'characters', 'writing-style'],
  'spiral-organizations': ['settings', 'worldview', 'characters', 'relations', 'writing-style'],
  'spiral-relationships': ['settings', 'characters', 'relations', 'worldview', 'writing-style'],
  'spiral-worldview-expand': ['settings', 'worldview', 'characters', 'relations', 'writing-style'],
  'spiral-outline': ['settings', 'outline', 'worldview', 'characters', 'relations', 'writing-style'],
  ...
  'market-analysis': ['settings', 'analysis', 'inspiration', 'outline'],
